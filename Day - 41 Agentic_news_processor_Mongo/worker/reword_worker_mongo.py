...
from utils.mongo_logger import log_article_to_mongo
...
def process_article(article_id):
    ...
    try:
        ...
        shutil.rmtree(working_folder) # Success
        log_article_to_mongo (article_data, "completed")
        logger.info(f"Completed: {article_id}")

    except Exception as e:
        # If error is insufficient_quota then halt execution and log messgae.
        # [2025-07-07 11:06:01,153] ERROR] OpenAI error during reword: Error code: 429 - {'error': {'message': 'You exceeded your current quota, please check your plan and billing details. For more information on this error, read the docs: https://platform.openai.com/docs/guides/error-codes/api-errors.', 'type': 'insufficient_quota', 'param': None, 'code': 'insufficient_quota'}}]
